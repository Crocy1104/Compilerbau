...
# define tok_PROGRAMM     	5
# define tok_VARIABLES          6
...
# define tok_IF 		14
# define tok_SEMIKOLON  	15
# define tok_ELSE 		16
# define tok_ENDIF 		17

# define tok_WHILE 		18
# define tok_DOPPELPUNKT	19
...
# define tok_MINUS 		28
# define tok_MULT 		29
# define tok_DIVIDE 		30

# define tok_BRACKETOP   	31
# define tok_BRACKETCL	 	32
...
EOF {
  ...
  if (bracketCounter > 0) {
      Message (" Zu viele offene Klammern!", xxError, l_scan_Attribute.Position);
  }
  if (bracketCounter < 0){
...
#STD# {Pp} {Rr} {Oo} {Gg} {Rr} {Aa} {Mm}          			: {return tok_PROGRAMM;}
...
#STD# {;}								: {return tok_SEMIKOLON;}
#STD# {Ee} {Nn} {Dd} {Ff} {Oo} {Rr} {.} 				: {return tok_ENDFOR;}
#STD# ">"					  			: {return tok_GT;}
#STD# "<" 					  			: {return tok_LT;}
#STD# {=}         							: {return tok_EQUAL;}
#STD# {+}      								: {return tok_PLUS;}
